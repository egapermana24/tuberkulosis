    ...
    <div class="col-xl-6 col-lg-6 col-md-12 mb-4 d-flex justify-content-end align-items-end">
      <div class="btn-group mx-1">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" id="tampilDewasa" href="#">Pertanyaan Dewasa</a>
          <a class="dropdown-item" id="tampilAnak" href="../pertanyaanank/">Pertanyaan Anak</a>
        </div>
      </div>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 mb-4">
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          ...
          <div class="table-responsive" id="tabelDewasa">
            <table class="table table-bordered tabelDewasa" id="dataTable" width="100%" cellspacing="0">
              <!-- membuat head -->
              <thead>
                <tr class="text-info">
                  <th>No</th>
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="../changepertanyaan/index.php?id_pertanyaan=<?= $data['id_pertanyaan']; ?>" class="btn btn-sm btn-info my-sm-2"><i class="fas fa-edit"></i></a>
                      <a href="#" class="btn btn-sm btn-danger delete-btn" data-toggle="modal" data-target="#deleteModal<?= $data['id_pertanyaan']; ?>" data-id="<?= $data['id_pertanyaan']; ?>"><i class="fas fa-trash"></i></a>

                      <!-- Delete Modal-->
                      <div class="modal fade" id="deleteModal<?= $data['id_pertanyaan']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
